...
contextBridge.exposeInMainWorld('launcher', {
  ...
  minecraftDetectJava(opts) {
    return ipcRenderer.invoke('minecraft:detect-java', opts);
  },
  javaInstall25() {
    return ipcRenderer.invoke('minecraft:install-java25');
  },
  prepareJavaRuntime() {
    return ipcRenderer.invoke('minecraft:prepare-java-runtime');
  },
  getAppVersion() {
